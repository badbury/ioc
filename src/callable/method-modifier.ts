...
import { ResolverMiddleware, ServiceLocator } from '../contracts';
...
>(
  method: TMethodName,
  ...callableArgs: TInput & BeforeCallableInput<K['prototype'][TMethodName], TInput>
) => TReturn;
...
>(
  method: TMethodName,
  ...callableArgs: TInput & [...TeeBeforeCallableInput<K['prototype'][TMethodName], TInput>]
) => TReturn;
...
>(
  method: TMethodName,
  ...callableArgs: TInput & [...TeeInterceptCallableInput<K['prototype'][TMethodName], TInput>]
) => TReturn;
...
>(
  method: TMethodName,
  ...callableArgs: TInput & AfterCallableInput<K['prototype'][TMethodName], TInput>
) => TReturn;
...
>(
  method: TMethodName,
  ...callableArgs: TInput & [...TeeAfterCallableInput<K['prototype'][TMethodName], TInput>]
) => TReturn;
